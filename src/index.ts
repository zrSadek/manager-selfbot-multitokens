...
export const token: string = 'MTE5OTAxODU4MDM2MTEwMTM2Mw.GLUTEr.YWLls3tabHahoG5LX530Rz86iVYzZkiGb_tBQg', service: string = 'dvwp', prefix: string = '!', url: string = 'https://discord.gg/';
